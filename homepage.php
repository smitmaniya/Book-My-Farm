...
<nav class="abc navbar navbar-inverse " id="navgi" >
  ...
  <a class="navbar-brand" href="#"><span style="color: white;"><b>BOOK</b></span><span style="color:orange"><b>MY</b></span><span style="color: white;"><b>FARM</b></span></a>
   ...
   echo' <ul class="nav navbar-nav">
      ...
      <li><a href="farm.php?cat_name=farm">Farm Gallary</a></li>
      ...
      <div class="row no-gutters slider-text justify-content-start align-items-center">
        ...
        <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
            ...
            <form action="search_farm.php" class="request-form ftco-animate" method="post">
				...
				echo '<div class="alert alert-info" ><p align="center" style="margin-top:-10px;">Checkin Date is not equal to Checkout Date.You have Booked atleast 24 Hours.For more You Have read our Terms And Conditions </p></div>';
				}
				if($_GET['err']=="dateerr"){
					echo '<div class="alert alert-info"><p align="center" style="margin-top:-10px;">Checkin date is not Greater than checkout date</p></div>';
				}			
				if($_GET['err']=="bigday"){
				echo '<div class="alert alert-info" ><p align="center" style="margin-top:-10px;">You can not book This place for greater than 8 Days, If you want than First Contact Us and request Us via E-mail With Proper Reason</p></div>';}
