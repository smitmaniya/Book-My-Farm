...
<body>
   ...
   echo' <ul class="nav navbar-nav">
      ...
      <li class="contact_index.php"><a href="#">Contact</a></li>
	...
	<div class="container-fluid">
		<div class = "row">
			...
			<div class="col-md-7">
				...
				<p class="info">BookMyFarm is a brainchild of Surat based business enthusiastic team Naren Zadfiya and TeamMembers.
		...
		<div class="row">
			...
			<img src="farm details photos/naren.jpg" class="thumbnail pull-right"style="height:40vh">
			<p class="heading" align="center">Founder And CEO</p>
			</div>
			...
			<p class="info">Mr. Naren is a multi-dimensional businessman and CEO of BookMyFarm. He shared equal hard work and success of BookMyFarm. This Ingenious duo is working with a vision to create a better environment for all the people to enjoy their holidays and generate hefty income.
