...
position: absolute;" background="farm details photos/banner.jpg">
        ...
        <div class="form-box">
            ...
            <form id="login" class="input-group" method="post" action="login-check.php">
                ...
                required><br><br>
				<p style="font-size:15px; color:red">User Already Exist Login Please!</p>
				<p style="font-size:12px; color:red ;padding-top:7px;">Try a Different email Or Mobile Number for Register</p>
